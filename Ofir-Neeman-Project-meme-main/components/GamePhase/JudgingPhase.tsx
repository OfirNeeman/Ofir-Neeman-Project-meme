...
// 1. הורדנו את ה-Interface שדרש personality
export const JudgingPhase: React.FC = () => {
  // 2. הורדנו את הלוגיקה של ה-switch וה-JUDGE_DESCRIPTIONS
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] space-y-12 text-center animate-fade-in">
      ...
      <div className="space-y-4 max-w-lg">
        ...
        <h2 className="outfit-bold text-5xl font-black text-white leading-tight">The diva is thinking...</h2>
        <p className="outfit-medium text-2xl text-pink-200 font-medium opacity-80">"Wait, I'm looking for the funny part"</p>
      </div>
